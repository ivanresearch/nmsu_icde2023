...
def read_all_feature_classification(parameter_file, function_keyword=""):
    if function_keyword == "":
    ...
    for line in lines:
        ...
        #     class_id = int(line.strip())
            ...
            model_setting.method = line.strip()
    ...
    if model_setting.method == 'cnn' or model_setting.method == 'fcn':
    ...
    #return data_keyword, data_folder, attr_num, attr_len, num_classes, start_class, class_column, class_id, obj_folder, method, log_folder, out_obj_folder, out_model_folder, cnn_setting_file, learning_rate, dropout
